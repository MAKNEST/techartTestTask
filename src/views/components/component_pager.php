...
function pager($page, $countPages) {
    ...
    if($button_1_page > 0) {
        getButton([
            ...
            'text' => $button_1_page,
            'button_class' => $button_1_page == $page ? 'button_selected' : 'pager_button',
        ]);
    }
    ...
    getButton([
        ...
        'text' => $button_2_page,
        'button_class' => $button_2_page == $page ? 'button_selected' : 'pager_button',
    ]);
    ...
    if(!($button_3_page > $countPages)) {
        getButton([
            ...
            'text' => $button_3_page,
            'button_class' => $button_3_page == $page ? 'button_selected' : 'pager_button',
        ]);
    }
