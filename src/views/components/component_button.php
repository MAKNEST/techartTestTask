 ...
 *  - string button_class - дополнительный класс стилизации кнопки
...
function getButton($param) {
    ...
    $param['button_class'] = $param['button_class'] ?? '';
    $param['link'] = $param['link'] ?? '#';
    $param['icon'] = $param['icon'] ?? '';
    $param['icon_postion'] = $param['icon_postion'] ?? 'left';

    ?>
    <button onclick="document.location='<?= $param['link']?>'" class="main_button <?= $param['button_class']?>">
        <?php
