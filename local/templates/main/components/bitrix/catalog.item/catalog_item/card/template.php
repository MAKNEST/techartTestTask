		...
		switch ($blockName)
		{
			...
			case 'quantity':
				if (!$haveOffers)
				{
					...
					{
						?>
						<div class="product-item-info-container product-item-hidden quantity_count" data-entity="quantity-block">
						...
						<div class="product-item-info-container product-item-hidden" data-entity="props-block">
							...
							<dl class="product-item-properties">
								...
								foreach ($item['DISPLAY_PROPERTIES'] as $code => $displayProperty)
								{
									...
									<dd class="<?=(!isset($item['PROPERTY_CODE_MOBILE'][$code]) ? 'hidden-xs author' : '')?>">
