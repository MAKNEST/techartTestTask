...
preg_match("{(?P<url>(news)/(?P<category>[0-9]+))/(?P<page>[0-9]+)?}", $_SERVER['REQUEST_URI'], $matches);
...
if ($page == 0 || is_null($page)) {
    $page = 1;
}

// кнопка назад
if ($page > 1): ?>
    <a href="<?= '?PAGEN_1=' . $page - 1; ?>" class="main_button pager_button">
        <svg width="26" height="16" viewbox="0 0 26 16" xmlns="http://www.w3.org/2000/svg" class="button_icon" fill="currentColor">
...
if ($button_1_page > 0): ?>
    <a href="<?= '?PAGEN_1=' . $button_1_page; ?>" class="main_button <?= $button_1_page == $page ? 'pager_button button_selected' : 'pager_button' ?>">
        <?= $button_1_page; ?>
    </a>
<?php endif;
...
if ($button_2_page <= $countPages): ?>
    <a href="<?= '?PAGEN_1=' . $button_2_page; ?>" class="main_button <?= $button_2_page == $page ? 'pager_button button_selected' : 'pager_button' ?>">
        <?= $button_2_page; ?>
    </a>
<?php endif;
...
if (!($button_3_page > $countPages)): ?>
    <a href="<?= '?PAGEN_1=' . $button_3_page; ?>" class="main_button <?= $button_3_page == $page ? 'pager_button button_selected' : 'pager_button' ?>">
        <?= $button_3_page; ?>
    </a>
<?php endif;
