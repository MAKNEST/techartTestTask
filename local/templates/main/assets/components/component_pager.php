...
function pager($page, $countPages) {
    ...
    if($page > 1) {
        getButton([
            ...
            'optional_button_class' => 'pager_button',
        ]);
    }
    ...
    if($button_1_page > 0) {
        getButton([
            'link' => '/news/all/' . $button_1_page,
            'text' => $button_1_page,
            'optional_button_class' => $button_1_page == $page ? 'pager_button button_selected' : 'pager_button',
        ]);
    }
    ...
    getButton([
        'link' => '/news/all/' . $button_2_page,
        'text' => $button_2_page,
        'optional_button_class' => $button_2_page == $page ? 'pager_button button_selected' : 'pager_button',
    ]);
    ...
    if(!($button_3_page > $countPages)) {
        getButton([
            'link' => '/news/all/' . $button_3_page,
            'text' => $button_3_page,
            'optional_button_class' => $button_3_page == $page ? 'pager_button button_selected' : 'pager_button',
        ]);
    }
