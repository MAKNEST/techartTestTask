...
$MESS ['MF_REQ_PHONE'] = "Вы не написали свой номер телефона.";
$MESS ['MF_PREG_PHONE'] = "Не правильный формат номера телефона";
$MESS ['MF_REQ_CHAPTER'] = "Вы не выбрали категорию.";
